    ...
    <div class="page-content-area">
        ...
        <section class="section-padding dashboard-section mb-5">
            <div class="container">
                                ...
                                <div class="job-dtl-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <h6>Work From Home :<span class="home-value">Yes</span></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="job-desc">
                                    ...
                                    <div class="cmpny-data">
                                        ...
                                        <div class="cmpny-text">
                                            ...
                                            @endif
                                              ...
                                              <!--   <p>{{$tbl_job->company_job_days}} </p>
                                                <p>{{$tbl_job->job_time}}</p>
                                                -->
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="apply-now-btn buttons-group text-center">
                            <a href="{{url('/employer-edit-post')}}/{{$tbl_job->job_slug}}" class="default-btn">Edit Job</a>
                            <button class="default-btn btn-red deletalert" data-id="{{$tbl_job->id}}">Delete</button>
                            <!-- <a onclick="if(confirm('Are You Sure?')){ window.location.href='{{url('/employer-delete-post')}}/{{$tbl_job->id}}'; }" href="javascript:void(0);" class="default-btn btn-red deletalert">Delete</a> -->
