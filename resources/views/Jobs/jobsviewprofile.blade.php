                        ...
                        <div class="dash-data-card h-100 mb-0">
                            <div class="profile-area">
                                <div class="profile-image">
                                    <img src="{{asset('assets')}}/images/default-user.png" class="profile-main-image" alt="">
                                </div>
                                <h5>Alex John</h5>
                                <p>UI / UX Designer</p>
                            </div>
                            ...
                            <div class="profile-box text-center mt-4">
                                <a href="javascript:void(0);" class="download-resume"><span>Download Resume</span><img src="{{asset('assets')}}/images/dashboard/download-resume.png" alt=""> </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-set-data">
                                            ...
                                            <div class="set-image"><img src="{{asset('assets')}}/images/dashboard/profile/proof.jpg" alt=""></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
