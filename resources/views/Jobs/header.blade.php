            ...
            <div class="menu-part mr-auto">
                <nav class="nav-bar">
                    <ul class="d-lg-flex menu-lists">
                        <li class="{{ Request::is('jobs-dashboard*') ? 'active' : '' }}"><a href="{{url('/jobs-dashboard')}}">Dashboard</a></li>
                        <li class="{{ Request::is('jobs') ? 'active' : '' }}"><a href="{{url('/jobs')}}">Jobs</a></li>
                        <li class="{{ Request::is('jobs-applied*') ? 'active' : '' }}"><a href="{{url('/jobs-applied')}}">Applied Jobs</a></li>
                        <li class="{{ Request::is('jobs-saved-jobs*') ? 'active' : '' }}"><a href="{{url('/jobs-saved-jobs')}}">Saved Jobs</a></li>
